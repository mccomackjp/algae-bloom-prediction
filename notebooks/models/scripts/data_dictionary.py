...
'''
Bucketing for the day
'''

day_dict = {'day_bucket': lambda x: str(round(x))}

'''
Dictionary for bucketing the week of the year
'''
week_dict = {'week_bucket': lambda x: str(round(x))}
'''
Dictionary for bucketing the month
'''

month_bucket = {
    'jan_bucket': lambda x: "January" if x == 1 else None,
    'feb_bucket': lambda x: "February" if x == 2 else None,
    'march_bucket': lambda x: "March" if x == 3 else None,
    'april_bucket': lambda x: "April" if x == 4 else None,
    'may_bucket': lambda x: "May" if x == 5 else None,
    'june_bucket': lambda x: "June" if x == 6 else None,
    'july_bucket': lambda x: "July" if x == 7 else None,
    'august_bucket': lambda x: "August" if x == 8 else None,
    'sep_bucket': lambda x: "September" if x == 9 else None,
    'ovt_bucket': lambda x: "October" if x == 10 else None,
    'nov_bucket': lambda x: "November" if x == 11 else None,
    'dec_bucket': lambda x: "December" if x == 12 else None
}
'''
